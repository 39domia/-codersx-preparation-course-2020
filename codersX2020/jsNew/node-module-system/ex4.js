 ...
 *  3. Circle có 1 method là isOverlapped (overlap là chồng lấn, đè lên nhau), 
 * trả về -1 nếu 2 hình tròn này đè lên nhau, 
 * trả về 1 nếu 2 hình tròn không đụng nhau, 
 * trả về 0 nếu 2 hình tròn tiếp xúc nhau.
 *  4. Test thử
 */


var Circle = require('./ex4-circle');
